...
class AxisXOptions: PropertyChangeObservable() {
    ...
    var computedValues: Values = Values.ALL
        set(value) {
            field = value
            _computedValues.set(value)
        }
    ...
    private val _computedValues: ObservableProperty<Values> by lazy { from(Values.ALL, ::computedValues, this) }
